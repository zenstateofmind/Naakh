...
import com.example.nikhiljoshi.naakh.network.Tasks.PostGCMRegistrationToken;
...
//        LocalBroadcastManager.getInstance(this).sendBroadcast(registrationComplete);
    ...
    private void sendRegistrationToServer(String registrationToken) {
        ...
        final String accessToken = sharedPreferences.getString(getString(R.string.token), "");
        final String android_id = Settings.Secure.getString(this.getContentResolver(),
                Settings.Secure.ANDROID_ID);

        new PostGCMRegistrationToken(api, registrationToken, android_id, accessToken).execute();
    }
